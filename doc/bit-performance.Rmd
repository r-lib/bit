...
```{r, echo=FALSE, fig.cap = "% size and execution time for bit (b) and bitwhich (w) relative to logical in the 'rare' scenario"}
oldpar <- par(xaxs="i")
x <- tim[1:3,,"rare"]
...
```{r, echo=FALSE, fig.cap = "% size and execution time for bit (b) and bitwhich (w) relative to logical in the 'coin' scenario"}
oldpar <- par(xaxs="i")
x <- tim[1:3,,"often"]
